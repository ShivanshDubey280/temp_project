...
class Jarvis:
    ...
    def execute_query(self, query):
        ...
        if 'jarvis who made you' in query:
            speak("Yes Sir, my master Shivansh Dubey me in AI")
            ...
            if platform == "win32" or "darwin":
                speak('Shivansh is my master. He created me couple of days ago')
            ...
            speak('I was created by my master SHIVANSH')
            ...
            webbrowser.get('brave').open_new_tab(
                'https://github.com/shivanshdubey280')
        ...
        elif 'email to Shivansh' in query:
            try:
